...
public class TestForTreeSizeLimit {
	 ...
	 * BoundedTreeSet.
	 * 
	 * Check that the set is bounded: ------------------------------ Check that
	 * the current sequence size never exceeds the set's capacity, i.e.
	 * SEQUENCE_SIZE.
	 * 
	 *************************************************************************/
	...
	private static ExecutorService executer = Executors.newFixedThreadPool(20);
...
//            }
	...
	public static <T extends BoundedSet<Integer>>  boolean hasFailed(T bset){
		while(true){
