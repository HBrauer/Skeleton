...
import util.html.*;
import util.time.BenchmarkTimer;
import util.file.*;
...
public final class DeadLinkDetector {
    ...
    public static void main(String[] args) {
        // waiting for input in order to begin a snapshot (for JProbe)
        System.out.println("shall we continue? <press RETURN>");
        try { System.in.read(); System.in.read(); } catch (Exception e) { e.printStackTrace(); }
        
        BenchmarkTimer.takeStartTime();
        ...
        BenchmarkTimer.takeEndTime();
        BenchmarkTimer.printDiffTime();
        
        // waiting for input in order to end a snapshot (for JProbe)
        System.out.println("shall we continue? <press RETURN>");
        try { System.in.read(); System.in.read(); } catch (Exception e) { e.printStackTrace(); }
